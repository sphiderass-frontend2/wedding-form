          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex md:flex-row flex-col items-center gap-4 justify-center">
                <button className="flex items-center justify-center gap-2 rounded-3xl md:py-4 md:px-6 p-3 border border-gray text-sm font-normal w-full">
                  <span>
                    <Image src={Google} alt="google-icon" width={20} />
                  </span>
                  Sign in with Google
                </button>
                <button className="flex items-center justify-center gap-2 rounded-3xl md:py-4 md:px-6 p-3 bg-accent text-white text-sm font-normal w-full">
                  <span>
